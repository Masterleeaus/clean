...
final class CreateCustomerAgent extends AbstractAIWorker
{
    public static function id(): string { return 'create-customer-agent'; }
    public static function name(): string { return 'Create Customer Agent'; }
