@php
    $skillsCount = \App\Extensions\SystemAIChatSkills\System\Models\Skill::query()->active()->count();
    $publicSkillsCount = \App\Extensions\SystemAIChatSkills\System\Models\Skill::query()->active()->public()->count();
@endphp
