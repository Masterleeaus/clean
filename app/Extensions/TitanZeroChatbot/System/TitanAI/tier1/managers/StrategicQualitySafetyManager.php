...
final class StrategicQualitySafetyManager extends AbstractAIWorker
{
    public static function id(): string { return 'strategic-quality-safety-manager'; }
    public static function name(): string { return 'Strategic Quality & Safety Manager'; }
