...
final class StrategicBusinessGrowthManager extends AbstractAIWorker
{
    public static function id(): string { return 'strategic-business-growth-manager'; }
    public static function name(): string { return 'Strategic Business Growth Manager'; }
