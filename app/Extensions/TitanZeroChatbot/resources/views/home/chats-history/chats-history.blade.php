@php
    ...
    $customerTagRoutes = [
        'index' => $hasCustomerTagExtension && \Route::has('dashboard.chatbot.inbox.customer-tags.index') ? route('dashboard.chatbot.inbox.customer-tags.index') : null,
        'store' => $hasCustomerTagExtension && \Route::has('dashboard.chatbot.inbox.customer-tags.store') ? route('dashboard.chatbot.inbox.customer-tags.store') : null,
        'sync' => $hasCustomerTagExtension && \Route::has('dashboard.chatbot.inbox.customer-tags.sync') ? route('dashboard.chatbot.inbox.customer-tags.sync') : null,
    ];
    $chatbotAgentRoutes = [
        'pin' => \Route::has('dashboard.chatbot.inbox.conversations.pinned') ? route('dashboard.chatbot.inbox.conversations.pinned') : null,
        'close' => \Route::has('dashboard.chatbot.inbox.conversations.closed') ? route('dashboard.chatbot.inbox.conversations.closed') : null,
        'delete' => \Route::has('dashboard.chatbot.inbox.destroy') ? route('dashboard.chatbot.inbox.destroy') : null,
    ];
@endphp
<div
