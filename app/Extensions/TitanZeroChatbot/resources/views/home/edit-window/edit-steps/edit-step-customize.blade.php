...
>
    ...
    <p class="text-xs/5 opacity-60 lg:max-w-[360px]">
        @lang('Shape the visual, conversational and customer-facing chatbot experience.')
    </p>

    <div class="flex flex-col gap-7 pt-9">
        @include('chatbot::home.edit-window.edit-steps.titan-shell-builder')
