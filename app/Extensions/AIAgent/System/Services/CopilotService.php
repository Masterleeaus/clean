...
- Always set `store_output_as` for output-producing steps (ai_call, generate_report, external_chatbot, marketing_bot, social_media_agent, gmail, outlook). Use a descriptive snake_case key (e.g. "ai_response", "report_output", "found_emails"). This key becomes the context variable `{key}` available in later steps.
...
PROMPT;
    ...
    {
        $stepTypes = ['ai_call', 'send_message', 'generate_report', 'path', 'external_chatbot', 'marketing_bot', 'social_media_agent', 'gmail', 'outlook'];
