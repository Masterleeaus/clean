<x-button
    ...
    size="none"
    href="{{ route('dashboard.chatbot.inbox.index') }}"
        ...
        <script>
            $(document).ready(function() {
                ...
                function fetchNotificationCount() {
                    $.ajax({
                        url: '{{ route('dashboard.chatbot.inbox.notification.count') }}',
                        type: 'GET',
                        success: function(data) {
                            let inboxNotification = $('#inbox-notification-chatbot');
