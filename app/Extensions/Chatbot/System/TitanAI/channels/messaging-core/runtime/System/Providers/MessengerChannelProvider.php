...
namespace App\Extensions\ChatbotMessenger\System\Providers;
...
final class MessengerChannelProvider implements ChannelProviderInterface
{
    public function __construct(private readonly array $config = []) {}

    public function key(): string { return 'messenger'; }
    ...
    {
        return WebhookSignatureVerifier::meta($headers, $body, (string) ($this->config['app_secret'] ?? ''));
    }
}
