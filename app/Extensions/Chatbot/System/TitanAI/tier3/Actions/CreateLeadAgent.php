...
final class CreateLeadAgent extends AbstractAIWorker
{
    public static function id(): string { return 'create-lead-agent'; }
    public static function name(): string { return 'Create Lead Agent'; }
