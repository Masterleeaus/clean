...
@section('content')
    ...
    >
        <x-table>
            <x-slot:head>
                <tr>
                    ...
                    <th>
                        {{ __('customer-tags::messages.tag') }}
                    </th>
                    <th>
                        {{ __('customer-tags::messages.tag_color') }}
                    </th>
                    <th>
                        {{ __('Created At') }}
                    </th>
        ...
        <x-modal id="customer-tag-modal">
            <x-slot:title>
                <span x-text="isEditing ? '{{ __('customer-tags::messages.edit_title') }}' : '{{ __('customer-tags::messages.create_title') }}'"></span>
            </x-slot:title>
            ...
            <x-slot:modal>
                ...
                >
                    <x-forms.input
                        ...
                        size="lg"
                        name="tag"
                        label="{{ __('customer-tags::messages.tag') }}"
                        placeholder="{{ __('customer-tags::messages.tag') }}"
                        x-model="form.tag"
                        required
                    ...
                    <x-forms.input
                        ...
                        size="lg"
                        name="tag_color"
                        label="{{ __('customer-tags::messages.tag_color') }}"
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('customerTagsPage', () => ({
                ...
                async openEditModal(id) {
                    ...
                    try {
                        const url = '{{ route('dashboard.customer-tagss.edit', ':id') }}'.replace(':id', id);
                ...
                async submitTag() {
                    ...
                    try {
                        const url = this.isEditing ?
                            '{{ route('dashboard.customer-tagss.update', ':id') }}'.replace(':id', this.editId) :
                            '{{ route('dashboard.customer-tagss.store') }}';
                ...
                async deleteTag(id) {
                    ...
                    try {
                        const url = '{{ route('dashboard.customer-tagss.destroy', ':id') }}'.replace(':id', id);
                        const response = await fetch(url, {
                            method: 'DELETE',
                            headers: {
                                Accept: 'application/json',
