...
final class SalesManager extends AbstractAIWorker
{
    public static function id(): string { return 'sales-manager'; }
    public static function name(): string { return 'Sales Manager'; }
