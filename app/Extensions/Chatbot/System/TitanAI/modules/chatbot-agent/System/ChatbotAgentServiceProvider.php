...
use App\Extensions\ChatbotAgent\System\Http\Controllers\CustomerTagsController;
    ...
    private function registerRoutes(): static
    {
        ...
        $this->router()
            ->group([
                ...
                if (MarketplaceHelper::isRegistered('customer-tags')) {
                    $router
                        ->controller(CustomerTagsController::class)
