...
namespace App\Extensions\Chatbot\System\Http\Controllers\StaffInbox;
...
use App\Extensions\Chatbot\System\Services\StaffInbox\ChatbotForFrameEventAbly;
...
class StaffInboxController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('chatbot::staff-inbox.index', compact('agentOptions'));
    }
