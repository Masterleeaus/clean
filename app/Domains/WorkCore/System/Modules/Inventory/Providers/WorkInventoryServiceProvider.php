...
final class WorkInventoryServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $read->register(new ReadModelDefinition('workcore.inventory.search', SearchInventory::class, 'workcore.inventory'));
        $read->register(new ReadModelDefinition('workcore.stock_locations.search', ListStockLocations::class, 'workcore.inventory'));
    }
