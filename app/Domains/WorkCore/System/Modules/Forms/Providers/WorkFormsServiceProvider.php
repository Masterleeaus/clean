...
final class WorkFormsServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $read->register(new ReadModelDefinition('workcore.form_template.search',SearchFormTemplates::class,'workcore.forms'));
        $read->register(new ReadModelDefinition('workcore.form_submission.search',SearchFormSubmissions::class,'workcore.forms'));
    }
