...
final class CreatePublicationChannelAction
{
    ...
    {
        return ['ok' => true, 'data' => $this->repository->createPublicationChannel($input, $this->context->companyId, $this->context->userId)];
    }
}
